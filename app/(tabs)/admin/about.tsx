...
const lightLogo = require("../../../assets/images/logo-hn-w.png");
const darkLogo = require("../../../assets/images/logo-hn-b.png");
      ...
      <SafeAreaView style={[styles.container, { backgroundColor: "transparent" }]}>
        ...
        >
          ...
          <View style={styles.sectionCard}>
            ...
            <Text style={styles.titulo}>{t("about.title")}</Text>
            <View style={{ alignItems: "center" }}>
              <Text style={styles.texto}>{t("about.text")}</Text>
              <Text style={styles.texto}>v 2.0</Text>
